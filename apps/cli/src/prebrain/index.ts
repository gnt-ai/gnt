// prebrain (fix-plan-v3 section 2): local walkers that turn a customer's
...
// Shared transcript chunker (connector sprint T2.1) -- speaker-turn and
// decision-moment-aware, built for mcp-granola.ts and reused by Zoom
// (T2.2) and the meeting-export walkers (T3.3). See its own doc comment.
...
// Gmail export walker (connector sprint T3.4) -- see gmail-export.ts's own
...
// Outlook export walker (connector sprint T3.5) -- see outlook-export.ts's
...
// Meeting-notes export walker (connector sprint T3.3) -- reads Otter/
...
// MCP-in walkers (fix-plan-v3 3.4) -- opt-in, live-network walkers, unlike
...
// Figma comments walker (connector sprint T2.7 v2) -- direct against
...
// Datadog notebooks client (connector sprint T2.6) -- direct against
...
// GitLab threads client (connector sprint T4.1) -- direct against GitLab's
...
// HubSpot notes client (connector sprint T2.8) -- direct against
...
// Airtable connector (connector sprint T4.4) -- direct against Airtable's
