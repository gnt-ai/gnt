...
This workspace is connected to gnt-brain, this org's rules-governance MCP server (see `gnt connect openclaw`). It exposes five tools: `check_action`, `search_rules`, `get_rule`, `list_skill_packs`, `get_skill_pack`.
