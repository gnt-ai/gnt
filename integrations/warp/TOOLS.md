# gnt-brain tools for Warp

This file is intended to be merged into a project's `AGENTS.md` or `WARP.md`, or added as a Warp
Global Rule. The MCP connection is configured separately; see [`CONNECT.md`](CONNECT.md).
