# gnt-brain tools for Gemini CLI

This file is intended to be imported by a `GEMINI.md` context file. The MCP connection is
configured separately; see [`CONNECT.md`](CONNECT.md).
